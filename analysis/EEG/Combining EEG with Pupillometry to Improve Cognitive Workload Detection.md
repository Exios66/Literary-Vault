...
• Key Findings: Combining EEG with pupillometry significantly improves cognitive workload detection accuracy compared to using either signal in isolation.
